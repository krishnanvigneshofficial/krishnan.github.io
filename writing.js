...
{
  index: 0,
  headline: 'Campaign Pitches',
  button: 'Read Now',
  link: 'inherlibido.html',
  src: '' },

{
  index: 1,
  headline: 'In my Libido',
  button: 'Read Now',
    link: 'inherlibido.html',
  src: '' },
...
class Slide extends React.Component {
  ...
  render() {
    ...
    return (
	  ...
	  React.createElement("a", {href: ''+link+'' }, React.createElement("button", {className: "slide__action btn" }, button) )
